...
#include "actor/add_vertex_actor.hpp"
...
class ActorAdapter {
 public:
    ...
    void Init() {
        ...
        actors_[ACTOR_T::ADDV] = unique_ptr<AbstractActor>(new AddVertexActor(id ++, num_thread_, mailbox_, core_affinity_));
        actors_[ACTOR_T::ADDE] = unique_ptr<AbstractActor>(new AddEdgeActor(id ++, num_thread_, node_.get_local_rank(), mailbox_, core_affinity_));
