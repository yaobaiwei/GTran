...
enum class ACTOR_T : char {
	INIT, ADDE, ADDV, AGGREGATE, AS, BRANCH, BRANCHFILTER, CAP, CONFIG, COUNT, DEDUP, DROP, GROUP, HAS, HASLABEL, INDEX,
	IS, KEY, LABEL, MATH, ORDER, PROPERTIES, PROPERTY, RANGE, SELECT, TRAVERSAL, VALUES, WHERE, COIN, REPEAT, END, VALIDATION
};

static const char *ActorType[] = { "INIT", "ADDE", "ADDV","AGGREGATE", "AS", "BRANCH", "BRANCHFILTER", "CAP", "CONFIG", "COUNT", "DEDUP", "DROP", "GROUP", "HAS",
"HASLABEL", "INDEX", "IS", "KEY", "LABEL", "MATH", "ORDER", "PROPERTIES","PROPERTY", "RANGE", "SELECT", "TRAVERSAL", "VALUES", "WHERE" , "COIN", "REPEAT", "END", "VALIDATION"};
